      ...
      const Tarjeta = `
        <div class="card" id="producto-${index}" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <input type="submit" class="submitBtn" data-producto="${index}" id="botonCom${index}" value="Coooooompre!!">
          </div>
        </div>
      `;
      index++;
...
///---------Carrito----------///
function alCarrito(){
  let botones = document.querySelectorAll(".submitBtn"); //trae un array
    ...
    response.forEach((product, index) => {
      ...
      <div class="card" id=producto"${index}" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a class="btn" data-producto="${index + 1}" id="botonCom${index}">Coooooompre!!</a>
          </div>
        </div>
      `;
